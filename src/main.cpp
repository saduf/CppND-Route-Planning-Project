...
{    
    ...
    std::cout << "Enters search coordinates, valid range [0,100]\n";
    ...
    // Limit coordinates values to min and max range (0,100)
    ...
    std::cout << "\nFinding path to coordinates:\n";
    std::cout << "(start_x, start_y) : (" << start_x << ", " << start_y << ")\n";
    std::cout << "(end_x, end_y)) : (" << end_x << ", " << end_y << ")\n";
